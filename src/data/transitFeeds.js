...
export const TRANSIT_FEED_REGISTRY = Object.freeze([
  ...
  Object.freeze({
    id: 'ctb-bilbobus',
    name: 'Bilbobus',
    operator: 'Consorcio de Transportes de Bizkaia (CTB)',
    region: 'Bilbao, Spain',
    center: Object.freeze({ lat: 43.263, lon: -2.935 }),
    loadRadiusKm: 80,
    url: 'https://ctb-gtfs-rt.s3.eu-south-2.amazonaws.com/bilbobus-vehicle-positions.pb',
    license: 'CC BY 4.0',
    licenseUrl: 'https://data.ctb.eus',
    attribution: 'Consorcio de Transportes de Bizkaia (CTB) — CC BY 4.0',
    defaultEnabled: true,
    terms: Object.freeze({
      quote: null,
      note: 'CTB publishes open transport data under CC BY 4.0 via data.ctb.eus. No key required. VehiclePositions served from a public S3 bucket.',
    }),
    defaultMode: 'bus',
  }),
  Object.freeze({
    ...
    terms: Object.freeze({
      quote: null,
      note: 'Metro Bilbao GTFS-RT published by CTB under CC BY 4.0. No key required.',
    }),
    defaultMode: 'rail',
  }),
  Object.freeze({
